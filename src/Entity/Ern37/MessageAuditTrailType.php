 ...
 *
 * A Composite containing information about Parties
 *  in between the original MessageSender and ultimate MessageRecipient.
...
class MessageAuditTrailType
{
     ...
     *  the MessageAuditTrail as defined in IETF RfC 5646. The default is the same as
     ...
     *  handling the Message and the Time at which the handling took
     *  place.
     *
     * @var \DedexBundle\Entity\Ern37\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrailEvent(\DedexBundle\Entity\Ern37\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     *  place.
     *
     * @return \DedexBundle\Entity\Ern37\MessageAuditTrailEventType[]
     */
