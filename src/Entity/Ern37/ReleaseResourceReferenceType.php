...
/**
 * Class representing ReleaseResourceReferenceType
 *
 * A Composite containing details of a
 *  ReleaseResourceReference.
 * XSD Type: ReleaseResourceReference
 */
class ReleaseResourceReferenceType
{
    /**
     * @var string $__value
     */
    ...
    /**
     * A Type of Resource in the context of a
     *  Release. This is represented in an XML schema as an XML
     *  Attribute.
     *
