...
class CueSheetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *  of the CueSheet.
     *
     * @var \DedexBundle\Entity\Ern37\CueSheetTypeType $cueSheetType
     */
     ...
     *  Cue.
     *
     * @var \DedexBundle\Entity\Ern37\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DedexBundle\Entity\Ern37\ProprietaryIdType $cueSheetId)
    {
     ...
     *  of the CueSheet.
     *
     * @return \DedexBundle\Entity\Ern37\CueSheetTypeType
     */
     ...
     *  of the CueSheet.
     *
     * @param \DedexBundle\Entity\Ern37\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DedexBundle\Entity\Ern37\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CueType $cue
     */
    public function addToCue(\DedexBundle\Entity\Ern37\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     *  Cue.
     *
     * @return \DedexBundle\Entity\Ern37\CueType[]
     */
