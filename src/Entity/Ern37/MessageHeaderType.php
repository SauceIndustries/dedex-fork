...
class MessageHeaderType
{
     ...
     *  thread of Messages of which the current Message is a part. One example of such a
     *  'thread' is the chain of NewReleaseMessages being sent from ReleaseCreator to
     *  wholesale ReleaseDistributor 1 to retail DSP when communicating information about
     *  the same Release(s). A common MessageThreadId will allow all these messages to be
     *  tied together. This element is deprecated. DDEX advises that this value will be
     ...
     *  MessageSender.
     *
     * @var \DedexBundle\Entity\Ern37\MessagingPartyType $messageSender
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\MessagingPartyType $sentOnBehalfOf
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\MessagingPartyType[] $messageRecipient
     */
     ...
     *  MessageRecipient.
     *
     * @var \DedexBundle\Entity\Ern37\MessageAuditTrailType $messageAuditTrail
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\CommentType $comment
     */
     ...
     *  MessageSender.
     *
     * @return \DedexBundle\Entity\Ern37\MessagingPartyType
     */
     ...
     *  MessageSender.
     *
     * @param \DedexBundle\Entity\Ern37\MessagingPartyType $messageSender
     * @return self
     */
    public function setMessageSender(\DedexBundle\Entity\Ern37\MessagingPartyType $messageSender)
    {
     ...
     *  Party on whose behalf the Message is sent.
     *
     * @param \DedexBundle\Entity\Ern37\MessagingPartyType $sentOnBehalfOf
     * @return self
     */
    public function setSentOnBehalfOf(?\DedexBundle\Entity\Ern37\MessagingPartyType $sentOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\MessagingPartyType $messageRecipient
     */
    public function addToMessageRecipient(\DedexBundle\Entity\Ern37\MessagingPartyType $messageRecipient)
    {
     ...
     *  MessageRecipient.
     *
     * @return \DedexBundle\Entity\Ern37\MessageAuditTrailType
     */
     ...
     *  MessageRecipient.
     *
     * @param \DedexBundle\Entity\Ern37\MessageAuditTrailType $messageAuditTrail
     * @return self
     */
    public function setMessageAuditTrail(?\DedexBundle\Entity\Ern37\MessageAuditTrailType $messageAuditTrail = null)
    {
     ...
     *  Comment about the Message.
     *
     * @param \DedexBundle\Entity\Ern37\CommentType $comment
     * @return self
     */
    public function setComment(?\DedexBundle\Entity\Ern37\CommentType $comment = null)
    {
