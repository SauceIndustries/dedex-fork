...
/**
 * Class representing ResourceOmissionReasonType
 *
 * A Composite containing details of a
 *  ResourceOmissionReason.
 * XSD Type: ResourceOmissionReason
 */
class ResourceOmissionReasonType
{
    /**
     * @var string $__value
     */
     ...
     *  ResourceOmissionReason. This is represented in an XML schema as an XML
     *  Attribute.
     *
