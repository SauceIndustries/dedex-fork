...
namespace DedexBundle\Entity\Ern37;
...
class DealTermsType
{
     ...
     *  the DealTerms as defined in IETF RfC 5646. The default is the same as indicated for
     ...
     *  fundamental business model which applies to the Deal (e.g. SubscriptionModel and
     *  PayAsYouGoModel). The CommercialModelType indicates how the Consumer pays for the
     *  Service or Release.
     *
     * @var \DedexBundle\Entity\Ern37\CommercialModelTypeType[] $commercialModelType
     */
     ...
     *  number of Usages applicable to a Release to which the Deal
     *  applies.
     *
     * @var \DedexBundle\Entity\Ern37\UsageType[] $usage
     */
    private $usage = [
    ...
    /**
     * The Flag indicating whether all Deals
     *  are cancelled for the given Territories (=True) or not (=False). This Flag can
     *  be used in conjunction with a StartDate of a ValidityPeriod to indicate the
     *  point in time from which all Deals are cancelled. This element is deprecated.
     *  DDEX advises that it may be removed at a future date and therefore recommends
     *  against using it.
     *
    ...
    /**
     * The Flag indicating whether all
     *  Releases referred to are to be taken down by the MessageRecipient. This
     *  includes that all Deals referred to in a specific Composite are cancelled and
     *  no information about the Releases should be displayed to the end user on the
     *  DSP's website (=True) or not (=False). This Flag can be used in conjunction
     *  with a StartDate of a ValidityPeriod to indicate the point in time from which
     *  all Deals are cancelled.
     *
     * @var bool $takeDown
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\CurrentTerritoryCodeType[] $territoryCode
     */
     ...
     *  are familiar with this standard.
     *
     * @var \DedexBundle\Entity\Ern37\CurrentTerritoryCodeType[] $excludedTerritoryCode
     */
    ...
    /**
     * A Composite containing details of the
     *  DSP through whose DistributionChannel the sales are permitted. If none are
     *  provided no limitations on the DistributionChannels are
     *  given.
     *
     * @var \DedexBundle\Entity\Ern37\DSPType[] $distributionChannel
     */
     ...
     *  excluded DSP. This is used in an aggregator model where all agreed partners of
     *  the aggregators may use a ReleaseDeal, except those that are listed
     *  herein.
     *
     * @var \DedexBundle\Entity\Ern37\DSPType[] $excludedDistributionChannel
     */
     ...
     *  Note that this Price applies to all UseTypes referenced in this
     *  Composite.
     *
     * @var \DedexBundle\Entity\Ern37\PriceInformationType[] $priceInformation
     */
    ...
    /**
     * The Flag indicating whether a special
     *  Deal is made between the Licensor and the Licensee (=True) or not (=False)
     *  regarding the royalties or payments due to be paid for Releases distributed
     *  under this Deal.
     *
     ...
     *  PromotionalCode.
     *
     * @var \DedexBundle\Entity\Ern37\PromotionalCodeType $promotionalCode
     */
    private $promotionalCode = null;

    /**
     * A Composite containing details about a
     *  Period of Time during which the Deal is valid. No StartDate in this Composite
     *  means that the Deal is valid as per contractual relationship between MessageSender
     *  and MessageRecipient. No EndDate in this Composite means that the Deal is valid
     *  until further notice.
     *
     * @var \DedexBundle\Entity\Ern37\PeriodType[] $validityPeriod
     */
    ...
    /**
     * A Composite containing details of a Period
     *  the DSP may rent something to a Customer.
     *
     * @var \DedexBundle\Entity\Ern37\ConsumerRentalPeriodType $consumerRentalPeriod
     */
    private $consumerRentalPeriod = null;

    /**
     * A Composite containing details of the Date
     *  and Place of the Event in which the related Release is made available for
     *  pre-ordering. This element is not applicable on Track Releases. This is a string
     *  with the syntax YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $preOrderReleaseDate
     */
    ...
    /**
     * A Composite containing details of the
     *  Date and Place of the Event in which the pre-ordered Release is made first
     *  available for previewing (it overrides the generic ReleaseDisplayStartDate if
     *  supplied). If no PreOrderPreviewDate is provided, the StartDate for the Deal is
     *  used instead. The PreOrderPreviewDate may not be later than the StartDate for
     *  the Deal. This element has been deprecated and may be deleted in a future
     *  version of this message. This is a string with the syntax
     *  YYYY[-MM[-DD]].
     *
     * @var string $preOrderPreviewDate
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $preOrderPreviewDateTime
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\DealResourceReferenceListType $preOrderIncentiveResourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\DealResourceReferenceListType $instantGratificationResourceList
     */
    private $instantGratificationResourceList = null;

    /**
     * The Flag indicating whether the Deal is
     *  exclusive (=True) or not (=False) to the MessageRecipient with respect to the
     *  relevant Territory(ies), Time(s) and Release(s). For other Territory(ies), or
     *  Time(s), other DSPs might be able to sell the Release(s). The exclusivity is in
     *  accordance with the agreement between the MessageSender and
     *  MessageRecipient.
     *
    ...
    /**
     * A Composite containing details of one or
     *  more offers related to the Release.
     *
     * @var \DedexBundle\Entity\Ern37\RelatedReleaseOfferSetType[] $relatedReleaseOfferSet
     */
    ...
    /**
     * A Composite containing details of physical
     *  returns.
     *
     * @var \DedexBundle\Entity\Ern37\PhysicalReturnsType $physicalReturns
     */
    private $physicalReturns = null;

    /**
     * A number of Products per carton. This is
     *  the smallest number of Products that can be ordered.
     *
    ...
    /**
     * A Composite containing details of a rights
     *  claim policy.
     *
     * @var \DedexBundle\Entity\Ern37\RightsClaimPolicyType[] $rightsClaimPolicy
     */
    ...
    /**
     * A Composite containing details of
     *  UserGeneratedContent permissions.
     *
     * @var \DedexBundle\Entity\Ern37\WebPolicyType[] $webPolicy
     */
    private $webPolicy = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CommercialModelTypeType $commercialModelType
     */
    public function addToCommercialModelType(\DedexBundle\Entity\Ern37\CommercialModelTypeType $commercialModelType)
    {
     ...
     *  Service or Release.
     *
     * @return \DedexBundle\Entity\Ern37\CommercialModelTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\UsageType $usage
     */
    public function addToUsage(\DedexBundle\Entity\Ern37\UsageType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     *  applies.
     *
     * @return \DedexBundle\Entity\Ern37\UsageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CurrentTerritoryCodeType $territoryCode
     */
    public function addToTerritoryCode(\DedexBundle\Entity\Ern37\CurrentTerritoryCodeType $territoryCode)
    {
     ...
     *  are familiar with this standard.
     *
     * @return \DedexBundle\Entity\Ern37\CurrentTerritoryCodeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CurrentTerritoryCodeType $excludedTerritoryCode
     */
    public function addToExcludedTerritoryCode(\DedexBundle\Entity\Ern37\CurrentTerritoryCodeType $excludedTerritoryCode)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\DSPType $distributionChannel
     */
    public function addToDistributionChannel(\DedexBundle\Entity\Ern37\DSPType $distributionChannel)
    {
     ...
     *  given.
     *
     * @return \DedexBundle\Entity\Ern37\DSPType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\DSPType $excludedDistributionChannel
     */
    public function addToExcludedDistributionChannel(\DedexBundle\Entity\Ern37\DSPType $excludedDistributionChannel)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\PriceInformationType $priceInformation
     */
    public function addToPriceInformation(\DedexBundle\Entity\Ern37\PriceInformationType $priceInformation)
    {
     ...
     *  Composite.
     *
     * @return \DedexBundle\Entity\Ern37\PriceInformationType[]
     */
     ...
     *  PromotionalCode.
     *
     * @return \DedexBundle\Entity\Ern37\PromotionalCodeType
     */
     ...
     *  PromotionalCode.
     *
     * @param \DedexBundle\Entity\Ern37\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(?\DedexBundle\Entity\Ern37\PromotionalCodeType $promotionalCode = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\PeriodType $validityPeriod
     */
    public function addToValidityPeriod(\DedexBundle\Entity\Ern37\PeriodType $validityPeriod)
    {
     ...
     *  until further notice.
     *
     * @return \DedexBundle\Entity\Ern37\PeriodType[]
     */
     ...
     *  the DSP may rent something to a Customer.
     *
     * @return \DedexBundle\Entity\Ern37\ConsumerRentalPeriodType
     */
     ...
     *  the DSP may rent something to a Customer.
     *
     * @param \DedexBundle\Entity\Ern37\ConsumerRentalPeriodType $consumerRentalPeriod
     * @return self
     */
    public function setConsumerRentalPeriod(?\DedexBundle\Entity\Ern37\ConsumerRentalPeriodType $consumerRentalPeriod = null)
    {
     ...
     *  with the syntax YYYY[-MM[-DD]].
     *
     * @return \DedexBundle\Entity\Ern37\EventDateType
     */
     ...
     *  with the syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $preOrderReleaseDate
     * @return self
     */
    public function setPreOrderReleaseDate(?\DedexBundle\Entity\Ern37\EventDateType $preOrderReleaseDate = null)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param string $preOrderPreviewDate
     * @return self
     */
    public function setPreOrderPreviewDate($preOrderPreviewDate)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $preOrderPreviewDateTime
     * @return self
     */
    public function setPreOrderPreviewDateTime(?\DedexBundle\Entity\Ern37\EventDateType $preOrderPreviewDateTime = null)
    {
     ...
     *  pre-order period (delivery is typically at ReleaseDate).
     *
     * @return \DedexBundle\Entity\Ern37\DealResourceReferenceListType
     */
     ...
     *  pre-order period (delivery is typically at ReleaseDate).
     *
     * @param \DedexBundle\Entity\Ern37\DealResourceReferenceListType $preOrderIncentiveResourceList
     * @return self
     */
    public function setPreOrderIncentiveResourceList(?\DedexBundle\Entity\Ern37\DealResourceReferenceListType $preOrderIncentiveResourceList = null)
    {
     ...
     *  purchased (i.e. before the ReleaseDate).
     *
     * @param \DedexBundle\Entity\Ern37\DealResourceReferenceListType $instantGratificationResourceList
     * @return self
     */
    public function setInstantGratificationResourceList(?\DedexBundle\Entity\Ern37\DealResourceReferenceListType $instantGratificationResourceList = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\RelatedReleaseOfferSetType $relatedReleaseOfferSet
     */
    public function addToRelatedReleaseOfferSet(\DedexBundle\Entity\Ern37\RelatedReleaseOfferSetType $relatedReleaseOfferSet)
    {
     ...
     *  more offers related to the Release.
     *
     * @return \DedexBundle\Entity\Ern37\RelatedReleaseOfferSetType[]
     */
     ...
     *  returns.
     *
     * @return \DedexBundle\Entity\Ern37\PhysicalReturnsType
     */
     ...
     *  returns.
     *
     * @param \DedexBundle\Entity\Ern37\PhysicalReturnsType $physicalReturns
     * @return self
     */
    public function setPhysicalReturns(?\DedexBundle\Entity\Ern37\PhysicalReturnsType $physicalReturns = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\RightsClaimPolicyType $rightsClaimPolicy
     */
    public function addToRightsClaimPolicy(\DedexBundle\Entity\Ern37\RightsClaimPolicyType $rightsClaimPolicy)
    {
     ...
     *  claim policy.
     *
     * @return \DedexBundle\Entity\Ern37\RightsClaimPolicyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\WebPolicyType $webPolicy
     */
    public function addToWebPolicy(\DedexBundle\Entity\Ern37\WebPolicyType $webPolicy)
    {
     ...
     *  UserGeneratedContent permissions.
     *
     * @return \DedexBundle\Entity\Ern37\WebPolicyType[]
     */
