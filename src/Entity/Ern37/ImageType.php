...
{
    /**
     * The Flag indicating whether the Image Element
     *  was updated (=True) or not (=False). When this Boolean Flag is set to true, the
     *  MessageRecipient is expected to replace any previously provided Image data with the
     ...
     *  the Image as defined in IETF RfC 5646. The default is the same as indicated for the
     ...
     *  of the Image.
     *
     * @var \DedexBundle\Entity\Ern37\ImageTypeType $imageType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ResourceProprietaryIdType[] $imageId
     */
    private $imageId = [
     ...
     *  of the Image within the Release which contains it. This is a LocalResourceAnchor
     ...
     *  and Place of the Event in which the Image was created. This is a string with the
     *  syntax YYYY[-MM[-DD]].
     *
     ...
     *  Image which may vary according to Territory of release.
     *
     * @var \DedexBundle\Entity\Ern37\ImageDetailsByTerritoryType[] $imageDetailsByTerritory
     */
     ...
     *  of the Image.
     *
     * @return \DedexBundle\Entity\Ern37\ImageTypeType
     */
     ...
     *  of the Image.
     *
     * @param \DedexBundle\Entity\Ern37\ImageTypeType $imageType
     * @return self
     */
    public function setImageType(?\DedexBundle\Entity\Ern37\ImageTypeType $imageType = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ResourceProprietaryIdType $imageId
     */
    public function addToImageId(\DedexBundle\Entity\Ern37\ResourceProprietaryIdType $imageId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ImageDetailsByTerritoryType $imageDetailsByTerritory
     */
    public function addToImageDetailsByTerritory(\DedexBundle\Entity\Ern37\ImageDetailsByTerritoryType $imageDetailsByTerritory)
    {
     ...
     *  Image which may vary according to Territory of release.
     *
     * @return \DedexBundle\Entity\Ern37\ImageDetailsByTerritoryType[]
     */
