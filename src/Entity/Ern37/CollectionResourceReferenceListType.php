...
class CollectionResourceReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern37\CollectionResourceReferenceType[] $collectionResourceReference
     */
     ...
     */
    public function addToCollectionResourceReference(\DedexBundle\Entity\Ern37\CollectionResourceReferenceType $collectionResourceReference)
    {
