...
class ArtistType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DedexBundle\Entity\Ern37\ArtistRoleType $artistRole)
    {
