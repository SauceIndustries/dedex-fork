...
class VideoDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\TitleType[] $title
     */
    private $title = [
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ArtistType[] $displayArtist
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ArtistType[] $displayConductor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\DetailedResourceContributorType[] $resourceContributor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\IndirectResourceContributorType[] $indirectResourceContributor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\RightsAgreementIdType $rightsAgreementId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\NameType[] $displayArtistName
     */
     ...
     *  scripts.
     *
     * @var \DedexBundle\Entity\Ern37\LabelNameType[] $labelName
     */
    private $labelName = [
     ...
     *
     * @var \DedexBundle\Entity\Ern37\TypedRightsControllerType[] $rightsController
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $remasteredDate
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $resourceReleaseDate
     */
     ...
     *  syntax YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $originalResourceReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\PLineType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DedexBundle\Entity\Ern37\CourtesyLineType $courtesyLine
     */
     ...
     *  information.
     *
     * @var \DedexBundle\Entity\Ern37\HostSoundCarrierType[] $hostSoundCarrier
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\CommentType $marketingComment
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\GenreType[] $genre
     */
    private $genre = [
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ParentalWarningTypeType[] $parentalWarningType
     */
     ...
     *  for the Video.
     *
     * @var \DedexBundle\Entity\Ern37\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *  FulfillmentDate.
     *
     * @var \DedexBundle\Entity\Ern37\FulfillmentDateType $fulfillmentDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\KeywordsType[] $keywords
     */
    private $keywords = [
     ...
     *
     * @var \DedexBundle\Entity\Ern37\SynopsisType $synopsis
     */
     ...
     *  CLine for the Video.
     *
     * @var \DedexBundle\Entity\Ern37\CLineType[] $cLine
     */
    private $cLine = [
     ...
     *  of the Video.
     *
     * @var \DedexBundle\Entity\Ern37\TechnicalVideoDetailsType[] $technicalVideoDetails
     */
     ...
     *  Roles.
     *
     * @var \DedexBundle\Entity\Ern37\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\TitleType $title
     */
    public function addToTitle(\DedexBundle\Entity\Ern37\TitleType $title)
    {
        $this->title[] = $title;
        return $this;
    }
     ...
     *  of the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern37\TitleType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ArtistType $displayArtist
     */
    public function addToDisplayArtist(\DedexBundle\Entity\Ern37\ArtistType $displayArtist)
    {
     ...
     *  Name, Identifier and Roles.
     *
     * @return \DedexBundle\Entity\Ern37\ArtistType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ArtistType $displayConductor
     */
    public function addToDisplayConductor(\DedexBundle\Entity\Ern37\ArtistType $displayConductor)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\DetailedResourceContributorType $resourceContributor
     */
    public function addToResourceContributor(\DedexBundle\Entity\Ern37\DetailedResourceContributorType $resourceContributor)
    {
     ...
     *  Contributor to the Video.
     *
     * @return \DedexBundle\Entity\Ern37\DetailedResourceContributorType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\IndirectResourceContributorType $indirectResourceContributor
     */
    public function addToIndirectResourceContributor(\DedexBundle\Entity\Ern37\IndirectResourceContributorType $indirectResourceContributor)
    {
     ...
     *  indirect Contributor to the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern37\IndirectResourceContributorType[]
     */
     ...
     *  used in the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern37\RightsAgreementIdType
     */
     ...
     *  used in the SoundRecording.
     *
     * @param \DedexBundle\Entity\Ern37\RightsAgreementIdType $rightsAgreementId
     * @return self
     */
    public function setRightsAgreementId(?\DedexBundle\Entity\Ern37\RightsAgreementIdType $rightsAgreementId = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\NameType $displayArtistName
     */
    public function addToDisplayArtistName(\DedexBundle\Entity\Ern37\NameType $displayArtistName)
    {
     ...
     *  the same XML message.
     *
     * @return \DedexBundle\Entity\Ern37\NameType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\LabelNameType $labelName
     */
    public function addToLabelName(\DedexBundle\Entity\Ern37\LabelNameType $labelName)
    {
     ...
     *  scripts.
     *
     * @return \DedexBundle\Entity\Ern37\LabelNameType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\TypedRightsControllerType $rightsController
     */
    public function addToRightsController(\DedexBundle\Entity\Ern37\TypedRightsControllerType $rightsController)
    {
     ...
     *  RightsController of Rights in the Video.
     *
     * @return \DedexBundle\Entity\Ern37\TypedRightsControllerType[]
     */
     ...
     *  digitally). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $remasteredDate
     * @return self
     */
    public function setRemasteredDate(?\DedexBundle\Entity\Ern37\EventDateType $remasteredDate = null)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $resourceReleaseDate
     * @return self
     */
    public function setResourceReleaseDate(?\DedexBundle\Entity\Ern37\EventDateType $resourceReleaseDate = null)
    {
     ...
     *  syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $originalResourceReleaseDate
     * @return self
     */
    public function setOriginalResourceReleaseDate(?\DedexBundle\Entity\Ern37\EventDateType $originalResourceReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\PLineType $pLine
     */
    public function addToPLine(\DedexBundle\Entity\Ern37\PLineType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     *  PLine for the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern37\PLineType[]
     */
     ...
     *  permission for guests Artists or others featured on the Video.
     *
     * @return \DedexBundle\Entity\Ern37\CourtesyLineType
     */
     ...
     *  permission for guests Artists or others featured on the Video.
     *
     * @param \DedexBundle\Entity\Ern37\CourtesyLineType $courtesyLine
     * @return self
     */
    public function setCourtesyLine(?\DedexBundle\Entity\Ern37\CourtesyLineType $courtesyLine = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\HostSoundCarrierType $hostSoundCarrier
     */
    public function addToHostSoundCarrier(\DedexBundle\Entity\Ern37\HostSoundCarrierType $hostSoundCarrier)
    {
     ...
     *  information.
     *
     * @return \DedexBundle\Entity\Ern37\HostSoundCarrierType[]
     */
     ...
     *  promotion and marketing of the Video.
     *
     * @return \DedexBundle\Entity\Ern37\CommentType
     */
     ...
     *  promotion and marketing of the Video.
     *
     * @param \DedexBundle\Entity\Ern37\CommentType $marketingComment
     * @return self
     */
    public function setMarketingComment(?\DedexBundle\Entity\Ern37\CommentType $marketingComment = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\GenreType $genre
     */
    public function addToGenre(\DedexBundle\Entity\Ern37\GenreType $genre)
    {
        $this->genre[] = $genre;
        return $this;
    }
     ...
     *  to which the Video belongs.
     *
     * @return \DedexBundle\Entity\Ern37\GenreType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ParentalWarningTypeType $parentalWarningType
     */
    public function addToParentalWarningType(\DedexBundle\Entity\Ern37\ParentalWarningTypeType $parentalWarningType)
    {
     ...
     *  of explicitness or offensiveness of its content.
     *
     * @return \DedexBundle\Entity\Ern37\ParentalWarningTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\AvRatingType $avRating
     */
    public function addToAvRating(\DedexBundle\Entity\Ern37\AvRatingType $avRating)
    {
     ...
     *  for the Video.
     *
     * @return \DedexBundle\Entity\Ern37\AvRatingType[]
     */
     ...
     *  FulfillmentDate.
     *
     * @return \DedexBundle\Entity\Ern37\FulfillmentDateType
     */
     ...
     *  FulfillmentDate.
     *
     * @param \DedexBundle\Entity\Ern37\FulfillmentDateType $fulfillmentDate
     * @return self
     */
    public function setFulfillmentDate(?\DedexBundle\Entity\Ern37\FulfillmentDateType $fulfillmentDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\KeywordsType $keywords
     */
    public function addToKeywords(\DedexBundle\Entity\Ern37\KeywordsType $keywords)
    {
     ...
     *  Description of the Video containing Keywords.
     *
     * @return \DedexBundle\Entity\Ern37\KeywordsType[]
     */
     ...
     *  Synopsis of the Video.
     *
     * @return \DedexBundle\Entity\Ern37\SynopsisType
     */
     ...
     *  Synopsis of the Video.
     *
     * @param \DedexBundle\Entity\Ern37\SynopsisType $synopsis
     * @return self
     */
    public function setSynopsis(?\DedexBundle\Entity\Ern37\SynopsisType $synopsis = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CLineType $cLine
     */
    public function addToCLine(\DedexBundle\Entity\Ern37\CLineType $cLine)
    {
        $this->cLine[] = $cLine;
        return $this;
    }
     ...
     *  CLine for the Video.
     *
     * @return \DedexBundle\Entity\Ern37\CLineType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\TechnicalVideoDetailsType $technicalVideoDetails
     */
    public function addToTechnicalVideoDetails(\DedexBundle\Entity\Ern37\TechnicalVideoDetailsType $technicalVideoDetails)
    {
     ...
     *  of the Video.
     *
     * @return \DedexBundle\Entity\Ern37\TechnicalVideoDetailsType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CharacterType $character
     */
    public function addToCharacter(\DedexBundle\Entity\Ern37\CharacterType $character)
    {
     ...
     *  Roles.
     *
     * @return \DedexBundle\Entity\Ern37\CharacterType[]
     */
