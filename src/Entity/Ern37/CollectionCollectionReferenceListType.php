...
class CollectionCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern37\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DedexBundle\Entity\Ern37\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern37\CollectionCollectionReferenceType[]
     */
