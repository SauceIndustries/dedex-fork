...
namespace DedexBundle\Entity\Ern37\CatalogListMessage;
...
class CatalogListMessageAnonymousPHPType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DedexBundle\Entity\Ern37\CatalogItemType $catalogItem)
    {
     ...
     *  Release which is an item of the catalog.
     *
     * @return \DedexBundle\Entity\Ern37\CatalogItemType[]
     */
