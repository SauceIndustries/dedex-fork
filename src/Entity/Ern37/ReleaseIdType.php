...
class ReleaseIdType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *  syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @return \DedexBundle\Entity\Ern37\ICPNType
     */
     ...
     *  syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @param \DedexBundle\Entity\Ern37\ICPNType $iCPN
     * @return self
     */
    public function setICPN(?\DedexBundle\Entity\Ern37\ICPNType $iCPN = null)
    {
        $this->iCPN = $iCPN;
        return $this;
    }
