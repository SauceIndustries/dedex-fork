...
class TechnicalSoundRecordingDetailsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\BitRateType $bitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\SamplingRateType $samplingRate
     */
     ...
     *  audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern37\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DedexBundle\Entity\Ern37\BitRateType $bitRate = null)
    {
     ...
     *  of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DedexBundle\Entity\Ern37\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(?\DedexBundle\Entity\Ern37\SamplingRateType $samplingRate = null)
    {
