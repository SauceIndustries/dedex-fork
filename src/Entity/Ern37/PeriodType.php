...
class PeriodType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $startDate
     */
     ...
     *  are provided.
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $endDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\EventDateTimeType $startDateTime
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\EventDateTimeType $endDateTime
     */
     ...
     *  if both are provided.
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $startDate
     * @return self
     */
    public function setStartDate(?\DedexBundle\Entity\Ern37\EventDateType $startDate = null)
    {
     ...
     *  are provided.
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $endDate
     * @return self
     */
    public function setEndDate(?\DedexBundle\Entity\Ern37\EventDateType $endDate = null)
    {
     ...
     *  the EndDateTime if both are provided.
     *
     * @return \DedexBundle\Entity\Ern37\EventDateTimeType
     */
     ...
     *  the EndDateTime if both are provided.
     *
     * @param \DedexBundle\Entity\Ern37\EventDateTimeType $startDateTime
     * @return self
     */
    public function setStartDateTime(?\DedexBundle\Entity\Ern37\EventDateTimeType $startDateTime = null)
    {
     ...
     *  than the StartDateTime if both are provided.
     *
     * @param \DedexBundle\Entity\Ern37\EventDateTimeType $endDateTime
     * @return self
     */
    public function setEndDateTime(?\DedexBundle\Entity\Ern37\EventDateTimeType $endDateTime = null)
    {
