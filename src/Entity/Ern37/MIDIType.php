...
{
    /**
     * The Flag indicating whether the MIDI Element
     *  was updated (=True) or not (=False). When this Boolean Flag is set to true, the
     *  MessageRecipient is expected to replace any previously provided MIDI data with the
     ...
     *  the MIDI as defined in IETF RfC 5646. The default is the same as indicated for the
     ...
     *  of the MIDI.
     *
     * @var \DedexBundle\Entity\Ern37\MidiTypeType $midiType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ResourceProprietaryIdType[] $midiId
     */
    private $midiId = [
    ...
    /**
     * A Composite containing details of a
     *  MusicalWorkId of a MusicalWork used in the MIDI.
     *
     * @var \DedexBundle\Entity\Ern37\MusicalWorkIdType[] $indirectMidiId
     */
     ...
     *  of the MIDI within the Release which contains it. This is a LocalResourceAnchor
     ...
     *  the Type of instrumentation of the MusicalWork(s) in the MIDI.
     *
    ...
    /**
     * The Flag indicating whether the MIDI is a
    ...
    /**
     * The Flag indicating whether the MIDI is
     *  generated by a computer (=True) or not (=False).
     *
     ...
     *  in the MIDI (represented by an ISO 639-2 LanguageCode).
     *
    ...
    /**
     * The Duration of the MIDI (using the ISO
     ...
     *  more MusicalWorks contained in the MIDI.
     *
     ...
     *  and Place of the Event in which the MIDI was created. This is a string with the
     *  syntax YYYY[-MM[-DD]].
     *
    ...
    /**
     * A Composite containing details of the Date
     *  and Place of the Event in which the MIDI was originally mastered (in either
     *  analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]]. This
    ...
    /**
     * A Composite containing details of
     *  Descriptors and other attributes of the MIDI which may vary according to Territory
     *  of release.
     *
     * @var \DedexBundle\Entity\Ern37\MidiDetailsByTerritoryType[] $midiDetailsByTerritory
     */
     ...
     *  of the MIDI.
     *
     * @return \DedexBundle\Entity\Ern37\MidiTypeType
     */
     ...
     *  of the MIDI.
     *
     * @param \DedexBundle\Entity\Ern37\MidiTypeType $midiType
     * @return self
     */
    public function setMidiType(?\DedexBundle\Entity\Ern37\MidiTypeType $midiType = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ResourceProprietaryIdType $midiId
     */
    public function addToMidiId(\DedexBundle\Entity\Ern37\ResourceProprietaryIdType $midiId)
    {
        $this->midiId[] = $midiId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\MusicalWorkIdType $indirectMidiId
     */
    public function addToIndirectMidiId(\DedexBundle\Entity\Ern37\MusicalWorkIdType $indirectMidiId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\MidiDetailsByTerritoryType $midiDetailsByTerritory
     */
    public function addToMidiDetailsByTerritory(\DedexBundle\Entity\Ern37\MidiDetailsByTerritoryType $midiDetailsByTerritory)
    {
     ...
     *  of release.
     *
     * @return \DedexBundle\Entity\Ern37\MidiDetailsByTerritoryType[]
     */
