...
/**
 * Class representing DistributionChannelTypeType
 *
 * A Composite containing details of a
 *  DistributionChannelType.
 * XSD Type: DistributionChannelType
 */
class DistributionChannelTypeType
{
    /**
     * @var string $__value
     */
     ...
     *  DistributionChannelType. This is represented in an XML schema as an XML
     *  Attribute.
     *
