...
/**
 * Class representing ParentalWarningTypeType
 *
 * A Composite containing details of a
 *  ParentalWarningType.
 * XSD Type: ParentalWarningType
 */
class ParentalWarningTypeType
{
    /**
     * @var string $__value
     */
     ...
     *  ParentalWarningType. This is represented in an XML schema as an XML
     *  Attribute.
     *
