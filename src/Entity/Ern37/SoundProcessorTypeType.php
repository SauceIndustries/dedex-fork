...
/**
 * Class representing SoundProcessorTypeType
 *
 * A Composite containing details of a
 *  SoundProcessorType.
 * XSD Type: SoundProcessorType
 */
class SoundProcessorTypeType
{
    /**
     * @var string $__value
     */
     ...
     *  SoundProcessorType. This is represented in an XML schema as an XML
     *  Attribute.
     *
     * @var string $version
     */
