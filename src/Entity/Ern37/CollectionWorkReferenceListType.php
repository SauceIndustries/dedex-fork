...
class CollectionWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern37\CollectionWorkReferenceType[] $collectionWorkReference
     */
     ...
     */
    public function addToCollectionWorkReference(\DedexBundle\Entity\Ern37\CollectionWorkReferenceType $collectionWorkReference)
    {
