...
class PriceInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\PriceTypeType $priceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\PriceRangeTypeType $priceRangeType
     */
     ...
     *  with PriceType.
     *
     * @var \DedexBundle\Entity\Ern37\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\PriceType $suggestedRetailPrice
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @return \DedexBundle\Entity\Ern37\PriceTypeType
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @param \DedexBundle\Entity\Ern37\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(?\DedexBundle\Entity\Ern37\PriceTypeType $priceType = null)
    {
     ...
     *  on the Price to be used by the DSP.
     *
     * @return \DedexBundle\Entity\Ern37\PriceRangeTypeType
     */
     ...
     *  on the Price to be used by the DSP.
     *
     * @param \DedexBundle\Entity\Ern37\PriceRangeTypeType $priceRangeType
     * @return self
     */
    public function setPriceRangeType(?\DedexBundle\Entity\Ern37\PriceRangeTypeType $priceRangeType = null)
    {
     ...
     *  with PriceType.
     *
     * @return \DedexBundle\Entity\Ern37\PriceType
     */
     ...
     *  with PriceType.
     *
     * @param \DedexBundle\Entity\Ern37\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DedexBundle\Entity\Ern37\PriceType $wholesalePricePerUnit = null)
    {
     ...
     *  not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern37\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DedexBundle\Entity\Ern37\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     *  suggested retail Price.
     *
     * @param \DedexBundle\Entity\Ern37\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DedexBundle\Entity\Ern37\PriceType $suggestedRetailPrice = null)
    {
