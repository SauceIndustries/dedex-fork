...
class ReleaseDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ReleaseTypeType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DedexBundle\Entity\Ern37\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\ResourceGroupType[] $resourceGroup
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $releaseDate
     */
     ...
     *  YYYY[-MM[-DD]]).
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $originalReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\EventDateType $originalDigitalReleaseDate
     */
     ...
     *  File.
     *
     * @var \DedexBundle\Entity\Ern37\DescriptionType[] $fileAvailabilityDescription
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern37\FileType[] $file
     */
    private $file = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DedexBundle\Entity\Ern37\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     *  AdministratingRecordCompany for the Release.
     *
     * @return \DedexBundle\Entity\Ern37\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ReleaseTypeType $releaseType
     */
    public function addToReleaseType(\DedexBundle\Entity\Ern37\ReleaseTypeType $releaseType)
    {
     ...
     *  overrides the ReleaseType specified globally for the Release.
     *
     * @return \DedexBundle\Entity\Ern37\ReleaseTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DedexBundle\Entity\Ern37\RelatedReleaseType $relatedRelease)
    {
     ...
     *  which is related to this Release.
     *
     * @return \DedexBundle\Entity\Ern37\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ResourceGroupType $resourceGroup
     */
    public function addToResourceGroup(\DedexBundle\Entity\Ern37\ResourceGroupType $resourceGroup)
    {
     ...
     *  default order of Resources within a Release.
     *
     * @return \DedexBundle\Entity\Ern37\ResourceGroupType[]
     */
     ...
     *  distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]).
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DedexBundle\Entity\Ern37\EventDateType $releaseDate = null)
    {
     ...
     *  YYYY[-MM[-DD]]).
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DedexBundle\Entity\Ern37\EventDateType $originalReleaseDate = null)
    {
     ...
     *  therefore recommends against using it.
     *
     * @param \DedexBundle\Entity\Ern37\EventDateType $originalDigitalReleaseDate
     * @return self
     */
    public function setOriginalDigitalReleaseDate(?\DedexBundle\Entity\Ern37\EventDateType $originalDigitalReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\DescriptionType $fileAvailabilityDescription
     */
    public function addToFileAvailabilityDescription(\DedexBundle\Entity\Ern37\DescriptionType $fileAvailabilityDescription)
    {
     ...
     *  File.
     *
     * @return \DedexBundle\Entity\Ern37\DescriptionType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\FileType $file
     */
    public function addToFile(\DedexBundle\Entity\Ern37\FileType $file)
    {
        $this->file[] = $file;
        return $this;
    }
     ...
     *  related Release File that a DSP can obtain.
     *
     * @return \DedexBundle\Entity\Ern37\FileType[]
     */
