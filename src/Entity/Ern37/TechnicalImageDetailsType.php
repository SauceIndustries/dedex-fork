...
class TechnicalImageDetailsType
{
     ...
     *  the TechnicalImageDetails as defined in IETF RfC 5646. The default is the same as
     ...
     *  of the TechnicalImageDetails within the Release which contains it. This is a
     ...
     *  of ImageCodec.
     *
     * @var \DedexBundle\Entity\Ern37\ImageCodecTypeType $imageCodecType
     */
    private $imageCodecType = null;

    /**
     * A Composite containing the vertical Extent
     *  of an Image of the Image and a UnitOfMeasure (the default is
     *  Pixels).
     *
     ...
     *  Extent of an Image of the Image and a UnitOfMeasure (the default is
     *  Pixels).
     *
     ...
     *  a pixel of the Image (given in bits per pixel).
     *
     * @var int $colorDepth
     */
    ...
    /**
     * A number of pixels of the Image displayed
     *  in a specific spatial range (given in dpi).
     *
    ...
    /**
     * The Flag indicating whether the Image is
     ...
     *  preview.
     *
     * @var \DedexBundle\Entity\Ern37\PreviewDetailsType $previewDetails
     */
     ...
     *  consumer is able to get hold of the Image.
     *
    ...
    /**
     * A Composite containing details of a
     *  File containing the Image that a DSP can obtain.
     *
     ...
     *  of ImageCodec.
     *
     * @return \DedexBundle\Entity\Ern37\ImageCodecTypeType
     */
     ...
     *  of ImageCodec.
     *
     * @param \DedexBundle\Entity\Ern37\ImageCodecTypeType $imageCodecType
     * @return self
     */
    public function setImageCodecType(?\DedexBundle\Entity\Ern37\ImageCodecTypeType $imageCodecType = null)
    {
     ...
     *  preview.
     *
     * @return \DedexBundle\Entity\Ern37\PreviewDetailsType
     */
     ...
     *  preview.
     *
     * @param \DedexBundle\Entity\Ern37\PreviewDetailsType $previewDetails
     * @return self
     */
    public function setPreviewDetails(?\DedexBundle\Entity\Ern37\PreviewDetailsType $previewDetails = null)
    {
