...
class CollectionListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern37\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\CollectionType $collection
     */
    public function addToCollection(\DedexBundle\Entity\Ern37\CollectionType $collection)
    {
     ...
     *  Collection contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern37\CollectionType[]
     */
