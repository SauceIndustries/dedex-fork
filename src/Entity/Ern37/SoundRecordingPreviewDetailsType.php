...
class SoundRecordingPreviewDetailsType
{
     ...
     *  intro.
     *
     * @var \DedexBundle\Entity\Ern37\DescriptionType $partType
     */
    private $partType = null;

    /**
     * The start point of the preview given in
     *  seconds from the start of the Resource.
     *
    ...
    /**
     * The end point of the preview given in
     *  seconds from the start of the Resource.
     *
     * @var float $endPoint
     */
    ...
    /**
     * The Duration of the preview, measured from
     *  the StartPoint.
     *
     ...
     *  intro.
     *
     * @param \DedexBundle\Entity\Ern37\DescriptionType $partType
     * @return self
     */
    public function setPartType(?\DedexBundle\Entity\Ern37\DescriptionType $partType = null)
    {
