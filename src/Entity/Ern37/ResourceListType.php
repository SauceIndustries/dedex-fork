...
class ResourceListType
{
     ...
     *  SoundRecording.
     *
     * @var \DedexBundle\Entity\Ern37\SoundRecordingType[] $soundRecording
     */
     ...
     *  MIDI.
     *
     * @var \DedexBundle\Entity\Ern37\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *  Video.
     *
     * @var \DedexBundle\Entity\Ern37\VideoType[] $video
     */
    private $video = [
     ...
     *  Image.
     *
     * @var \DedexBundle\Entity\Ern37\ImageType[] $image
     */
    private $image = [
     ...
     *  Text.
     *
     * @var \DedexBundle\Entity\Ern37\TextType[] $text
     */
    private $text = [
     ...
     *  SheetMusic.
     *
     * @var \DedexBundle\Entity\Ern37\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *  of Software.
     *
     * @var \DedexBundle\Entity\Ern37\SoftwareType[] $software
     */
    private $software = [
     ...
     *  UserDefinedResource.
     *
     * @var \DedexBundle\Entity\Ern37\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern37\SoundRecordingType $soundRecording)
    {
     ...
     *  SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern37\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\MIDIType $mIDI
     */
    public function addToMIDI(\DedexBundle\Entity\Ern37\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     *  MIDI.
     *
     * @return \DedexBundle\Entity\Ern37\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\VideoType $video
     */
    public function addToVideo(\DedexBundle\Entity\Ern37\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     *  Video.
     *
     * @return \DedexBundle\Entity\Ern37\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ImageType $image
     */
    public function addToImage(\DedexBundle\Entity\Ern37\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     *  Image.
     *
     * @return \DedexBundle\Entity\Ern37\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\TextType $text
     */
    public function addToText(\DedexBundle\Entity\Ern37\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  Text.
     *
     * @return \DedexBundle\Entity\Ern37\TextType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern37\SheetMusicType $sheetMusic)
    {
     ...
     *  SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern37\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\SoftwareType $software
     */
    public function addToSoftware(\DedexBundle\Entity\Ern37\SoftwareType $software)
    {
     ...
     *  of Software.
     *
     * @return \DedexBundle\Entity\Ern37\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DedexBundle\Entity\Ern37\UserDefinedResourceType $userDefinedResource)
    {
     ...
     *  UserDefinedResource.
     *
     * @return \DedexBundle\Entity\Ern37\UserDefinedResourceType[]
     */
