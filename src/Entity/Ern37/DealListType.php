...
class DealListType
{
     ...
     *  the DealList as defined in IETF RfC 5646. The default is the same as indicated for
     ...
     *  more Deals pertaining to one or more Releases.
     *
     * @var \DedexBundle\Entity\Ern37\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern37\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DedexBundle\Entity\Ern37\ReleaseDealType $releaseDeal)
    {
     ...
     *  more Deals pertaining to one or more Releases.
     *
     * @return \DedexBundle\Entity\Ern37\ReleaseDealType[]
     */
