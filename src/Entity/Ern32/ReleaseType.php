...
class ReleaseType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\SalesReportingProxyReleaseIdType[] $salesReportingProxyReleaseId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ResourceOmissionReasonType $resourceOmissionReason
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ReleaseCollectionReferenceListType $releaseCollectionReferenceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\WebPageType[] $artistProfilePage
     */
     ...
     *  it.
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $globalReleaseDate
     */
     ...
     *  it.
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $globalOriginalReleaseDate
     */
     ...
     */
    public function addToReleaseId(\DedexBundle\Entity\Ern32\ReleaseIdType $releaseId)
    {
     ...
     * @return self
     */
    public function setReleaseReference(array $releaseReference)
    {
        $this->releaseReference = $releaseReference;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DedexBundle\Entity\Ern32\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     *  promotional or other material related to the Release.
     *
     * @return \DedexBundle\Entity\Ern32\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\SalesReportingProxyReleaseIdType $salesReportingProxyReleaseId
     */
    public function addToSalesReportingProxyReleaseId(\DedexBundle\Entity\Ern32\SalesReportingProxyReleaseIdType $salesReportingProxyReleaseId)
    {
     ...
     *  SalesReportingProxyReleaseId.
     *
     * @return \DedexBundle\Entity\Ern32\SalesReportingProxyReleaseIdType[]
     */
     ...
     * @return self
     */
    public function setSalesReportingProxyReleaseId(array $salesReportingProxyReleaseId)
    {
        $this->salesReportingProxyReleaseId = $salesReportingProxyReleaseId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ReleaseResourceReferenceType $releaseResourceReference
     */
    public function addToReleaseResourceReferenceList(\DedexBundle\Entity\Ern32\ReleaseResourceReferenceType $releaseResourceReference)
    {
     ...
     *  or more Resources contained in the Release.
     *
     * @return \DedexBundle\Entity\Ern32\ReleaseResourceReferenceType[]
     */
     ...
     *  or more Resources contained in the Release.
     *
     * @param \DedexBundle\Entity\Ern32\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     * @return self
     */
     ...
     *  ResourceOmissionReason.
     *
     * @return \DedexBundle\Entity\Ern32\ResourceOmissionReasonType
     */
     ...
     *  ResourceOmissionReason.
     *
     * @param \DedexBundle\Entity\Ern32\ResourceOmissionReasonType $resourceOmissionReason
     * @return self
     */
    public function setResourceOmissionReason(\DedexBundle\Entity\Ern32\ResourceOmissionReasonType $resourceOmissionReason)
    {
     ...
     *  more Collections contained in the Release.
     *
     * @return \DedexBundle\Entity\Ern32\ReleaseCollectionReferenceListType
     */
     ...
     *  more Collections contained in the Release.
     *
     * @param \DedexBundle\Entity\Ern32\ReleaseCollectionReferenceListType $releaseCollectionReferenceList
     * @return self
     */
    public function setReleaseCollectionReferenceList(\DedexBundle\Entity\Ern32\ReleaseCollectionReferenceListType $releaseCollectionReferenceList)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DedexBundle\Entity\Ern32\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     *  Territory of release.
     *
     * @return \DedexBundle\Entity\Ern32\ReleaseDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\WebPageType $artistProfilePage
     */
    public function addToArtistProfilePage(\DedexBundle\Entity\Ern32\WebPageType $artistProfilePage)
    {
     ...
     *  WebPage for the Artist.
     *
     * @return \DedexBundle\Entity\Ern32\WebPageType[]
     */
     ...
     *  it.
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $globalReleaseDate
     * @return self
     */
    public function setGlobalReleaseDate(\DedexBundle\Entity\Ern32\EventDateType $globalReleaseDate)
    {
     ...
     *  it.
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $globalOriginalReleaseDate
     * @return self
     */
    public function setGlobalOriginalReleaseDate(\DedexBundle\Entity\Ern32\EventDateType $globalOriginalReleaseDate)
    {
