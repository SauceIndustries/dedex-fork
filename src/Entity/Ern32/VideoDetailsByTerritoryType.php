...
class VideoDetailsByTerritoryType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\TitleType[] $title
     */
    private $title = [
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ArtistType[] $displayArtist
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ArtistType[] $displayConductor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\DetailedResourceContributorType[] $resourceContributor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\IndirectResourceContributorType[] $indirectResourceContributor
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\RightsAgreementIdType $rightsAgreementId
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\NameType[] $displayArtistName
     */
     ...
     *  scripts.
     *
     * @var \DedexBundle\Entity\Ern32\LabelNameType[] $labelName
     */
    private $labelName = [
     ...
     *
     * @var \DedexBundle\Entity\Ern32\TypedRightsControllerType[] $rightsController
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $remasteredDate
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $resourceReleaseDate
     */
     ...
     *  syntax YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $originalResourceReleaseDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PLineType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DedexBundle\Entity\Ern32\CourtesyLineType $courtesyLine
     */
     ...
     *  information.
     *
     * @var \DedexBundle\Entity\Ern32\HostSoundCarrierType[] $hostSoundCarrier
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\CommentType $marketingComment
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\GenreType[] $genre
     */
    private $genre = [
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ParentalWarningTypeType[] $parentalWarningType
     */
     ...
     *  for the Video.
     *
     * @var \DedexBundle\Entity\Ern32\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *  FulfillmentDate.
     *
     * @var \DedexBundle\Entity\Ern32\FulfillmentDateType $fulfillmentDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\KeywordsType[] $keywords
     */
    private $keywords = [
     ...
     *
     * @var \DedexBundle\Entity\Ern32\SynopsisType $synopsis
     */
     ...
     *  CLine for the Video.
     *
     * @var \DedexBundle\Entity\Ern32\CLineType[] $cLine
     */
    private $cLine = [
     ...
     *  of the Video.
     *
     * @var \DedexBundle\Entity\Ern32\TechnicalVideoDetailsType[] $technicalVideoDetails
     */
     ...
     *  Roles.
     *
     * @var \DedexBundle\Entity\Ern32\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\TitleType $title
     */
    public function addToTitle(\DedexBundle\Entity\Ern32\TitleType $title)
    {
        $this->title[] = $title;
        return $this;
    }
     ...
     *  of the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern32\TitleType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ArtistType $displayArtist
     */
    public function addToDisplayArtist(\DedexBundle\Entity\Ern32\ArtistType $displayArtist)
    {
     ...
     *  Name, Identifier and Roles.
     *
     * @return \DedexBundle\Entity\Ern32\ArtistType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ArtistType $displayConductor
     */
    public function addToDisplayConductor(\DedexBundle\Entity\Ern32\ArtistType $displayConductor)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\DetailedResourceContributorType $resourceContributor
     */
    public function addToResourceContributor(\DedexBundle\Entity\Ern32\DetailedResourceContributorType $resourceContributor)
    {
     ...
     *  Contributor to the Video.
     *
     * @return \DedexBundle\Entity\Ern32\DetailedResourceContributorType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\IndirectResourceContributorType $indirectResourceContributor
     */
    public function addToIndirectResourceContributor(\DedexBundle\Entity\Ern32\IndirectResourceContributorType $indirectResourceContributor)
    {
     ...
     *  indirect Contributor to the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern32\IndirectResourceContributorType[]
     */
     ...
     *  used in the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern32\RightsAgreementIdType
     */
     ...
     *  used in the SoundRecording.
     *
     * @param \DedexBundle\Entity\Ern32\RightsAgreementIdType $rightsAgreementId
     * @return self
     */
    public function setRightsAgreementId(\DedexBundle\Entity\Ern32\RightsAgreementIdType $rightsAgreementId)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\NameType $displayArtistName
     */
    public function addToDisplayArtistName(\DedexBundle\Entity\Ern32\NameType $displayArtistName)
    {
     ...
     *  the same XML message.
     *
     * @return \DedexBundle\Entity\Ern32\NameType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\LabelNameType $labelName
     */
    public function addToLabelName(\DedexBundle\Entity\Ern32\LabelNameType $labelName)
    {
     ...
     *  scripts.
     *
     * @return \DedexBundle\Entity\Ern32\LabelNameType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\TypedRightsControllerType $rightsController
     */
    public function addToRightsController(\DedexBundle\Entity\Ern32\TypedRightsControllerType $rightsController)
    {
     ...
     *  RightsController of Rights in the Video.
     *
     * @return \DedexBundle\Entity\Ern32\TypedRightsControllerType[]
     */
     ...
     *  digitally). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $remasteredDate
     * @return self
     */
    public function setRemasteredDate(\DedexBundle\Entity\Ern32\EventDateType $remasteredDate)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $resourceReleaseDate
     * @return self
     */
    public function setResourceReleaseDate(\DedexBundle\Entity\Ern32\EventDateType $resourceReleaseDate)
    {
     ...
     *  syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $originalResourceReleaseDate
     * @return self
     */
    public function setOriginalResourceReleaseDate(\DedexBundle\Entity\Ern32\EventDateType $originalResourceReleaseDate)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\PLineType $pLine
     */
    public function addToPLine(\DedexBundle\Entity\Ern32\PLineType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     *  PLine for the SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern32\PLineType[]
     */
     ...
     *  permission for guests Artists or others featured on the Video.
     *
     * @return \DedexBundle\Entity\Ern32\CourtesyLineType
     */
     ...
     *  permission for guests Artists or others featured on the Video.
     *
     * @param \DedexBundle\Entity\Ern32\CourtesyLineType $courtesyLine
     * @return self
     */
    public function setCourtesyLine(\DedexBundle\Entity\Ern32\CourtesyLineType $courtesyLine)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\HostSoundCarrierType $hostSoundCarrier
     */
    public function addToHostSoundCarrier(\DedexBundle\Entity\Ern32\HostSoundCarrierType $hostSoundCarrier)
    {
     ...
     *  information.
     *
     * @return \DedexBundle\Entity\Ern32\HostSoundCarrierType[]
     */
     ...
     *  promotion and marketing of the Video.
     *
     * @return \DedexBundle\Entity\Ern32\CommentType
     */
     ...
     *  promotion and marketing of the Video.
     *
     * @param \DedexBundle\Entity\Ern32\CommentType $marketingComment
     * @return self
     */
    public function setMarketingComment(\DedexBundle\Entity\Ern32\CommentType $marketingComment)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\GenreType $genre
     */
    public function addToGenre(\DedexBundle\Entity\Ern32\GenreType $genre)
    {
        $this->genre[] = $genre;
        return $this;
    }
     ...
     *  to which the Video belongs.
     *
     * @return \DedexBundle\Entity\Ern32\GenreType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ParentalWarningTypeType $parentalWarningType
     */
    public function addToParentalWarningType(\DedexBundle\Entity\Ern32\ParentalWarningTypeType $parentalWarningType)
    {
     ...
     *  of explicitness or offensiveness of its content.
     *
     * @return \DedexBundle\Entity\Ern32\ParentalWarningTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\AvRatingType $avRating
     */
    public function addToAvRating(\DedexBundle\Entity\Ern32\AvRatingType $avRating)
    {
     ...
     *  for the Video.
     *
     * @return \DedexBundle\Entity\Ern32\AvRatingType[]
     */
     ...
     *  FulfillmentDate.
     *
     * @return \DedexBundle\Entity\Ern32\FulfillmentDateType
     */
     ...
     *  FulfillmentDate.
     *
     * @param \DedexBundle\Entity\Ern32\FulfillmentDateType $fulfillmentDate
     * @return self
     */
    public function setFulfillmentDate(\DedexBundle\Entity\Ern32\FulfillmentDateType $fulfillmentDate)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\KeywordsType $keywords
     */
    public function addToKeywords(\DedexBundle\Entity\Ern32\KeywordsType $keywords)
    {
     ...
     *  Description of the Video containing Keywords.
     *
     * @return \DedexBundle\Entity\Ern32\KeywordsType[]
     */
     ...
     *  Synopsis of the Video.
     *
     * @return \DedexBundle\Entity\Ern32\SynopsisType
     */
     ...
     *  Synopsis of the Video.
     *
     * @param \DedexBundle\Entity\Ern32\SynopsisType $synopsis
     * @return self
     */
    public function setSynopsis(\DedexBundle\Entity\Ern32\SynopsisType $synopsis)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\CLineType $cLine
     */
    public function addToCLine(\DedexBundle\Entity\Ern32\CLineType $cLine)
    {
        $this->cLine[] = $cLine;
        return $this;
    }
     ...
     *  CLine for the Video.
     *
     * @return \DedexBundle\Entity\Ern32\CLineType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\TechnicalVideoDetailsType $technicalVideoDetails
     */
    public function addToTechnicalVideoDetails(\DedexBundle\Entity\Ern32\TechnicalVideoDetailsType $technicalVideoDetails)
    {
     ...
     *  of the Video.
     *
     * @return \DedexBundle\Entity\Ern32\TechnicalVideoDetailsType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\CharacterType $character
     */
    public function addToCharacter(\DedexBundle\Entity\Ern32\CharacterType $character)
    {
     ...
     *  Roles.
     *
     * @return \DedexBundle\Entity\Ern32\CharacterType[]
     */
