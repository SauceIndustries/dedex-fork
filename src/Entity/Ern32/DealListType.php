...
class DealListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DedexBundle\Entity\Ern32\ReleaseDealType $releaseDeal)
    {
     ...
     *  more Deals pertaining to one or more Releases.
     *
     * @return \DedexBundle\Entity\Ern32\ReleaseDealType[]
     */
