...
class MusicalWorkType
{
    ...
    /**
     * The Flag indicating whether the MusicalWork
     *  Element was updated (=true) or not (=false). When this Boolean Flag is set to true,
     *  the MessageRecipient is expected to replace any previously provided MusicalWork data
     ...
     *  the MusicalWork as defined in IETF RfC 5646. The default is the same as indicated for
    ...
    /**
     * A Composite containing details of a
     *  MusicalWorkId of the MusicalWork.
     *
     * @var \DedexBundle\Entity\Ern32\MusicalWorkIdType[] $musicalWorkId
     */
     ...
     *  of the MusicalWork within the Release which contains it. This is a
     *  LocalMusicalWorkAnchor starting with the letter W.
     *
    ...
    /**
     * A Composite containing details of a
     *  ReferenceTitle of the MusicalWork.
     *
     ...
     *  Identifiers of a License, Claim, RightShare or contract for the
     *  MusicalWork.
     *
     ...
     *  MusicalWorkContributor to the MusicalWork.
     *
     * @var \DedexBundle\Entity\Ern32\MusicalWorkContributorType[] $musicalWorkContributor
     */
     ...
     *  of the MusicalWork.
     *
     * @var \DedexBundle\Entity\Ern32\MusicalWorkTypeType[] $musicalWorkType
     */
    ...
    /**
     * A Composite containing details of a
     *  RightShare for the MusicalWork.
     *
     * @var \DedexBundle\Entity\Ern32\RightShareType[] $rightShare
     */
    private $rightShare = [
    ...
    /**
     * A Composite containing details of
     *  Descriptors and other attributes of the MusicalWork which may vary according to
     *  Territory of release.
     *
     * @var \DedexBundle\Entity\Ern32\MusicalWorkDetailsByTerritoryType[] $musicalWorkDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\MusicalWorkIdType $musicalWorkId
     */
    public function addToMusicalWorkId(\DedexBundle\Entity\Ern32\MusicalWorkIdType $musicalWorkId)
    {
     ...
     */
    public function addToReferenceTitle(\DedexBundle\Entity\Ern32\ReferenceTitleType $referenceTitle)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\MusicalWorkContributorType $musicalWorkContributor
     */
    public function addToMusicalWorkContributor(\DedexBundle\Entity\Ern32\MusicalWorkContributorType $musicalWorkContributor)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\MusicalWorkTypeType $musicalWorkType
     */
    public function addToMusicalWorkType(\DedexBundle\Entity\Ern32\MusicalWorkTypeType $musicalWorkType)
    {
     ...
     *  of the MusicalWork.
     *
     * @return \DedexBundle\Entity\Ern32\MusicalWorkTypeType[]
     */
     ...
     * @return self
     */
    public function setMusicalWorkType(array $musicalWorkType)
    {
        $this->musicalWorkType = $musicalWorkType;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\RightShareType $rightShare
     */
    public function addToRightShare(\DedexBundle\Entity\Ern32\RightShareType $rightShare)
    {
     ...
     *  RightShare for the MusicalWork.
     *
     * @return \DedexBundle\Entity\Ern32\RightShareType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\MusicalWorkDetailsByTerritoryType $musicalWorkDetailsByTerritory
     */
    public function addToMusicalWorkDetailsByTerritory(\DedexBundle\Entity\Ern32\MusicalWorkDetailsByTerritoryType $musicalWorkDetailsByTerritory)
    {
     ...
     *  Territory of release.
     *
     * @return \DedexBundle\Entity\Ern32\MusicalWorkDetailsByTerritoryType[]
     */
     ...
     * @return self
     */
    public function setMusicalWorkDetailsByTerritory(array $musicalWorkDetailsByTerritory)
    {
        $this->musicalWorkDetailsByTerritory = $musicalWorkDetailsByTerritory;
        return $this;
    }
