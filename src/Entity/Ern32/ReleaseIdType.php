...
class ReleaseIdType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *  syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @return \DedexBundle\Entity\Ern32\ICPNType
     */
     ...
     *  syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @param \DedexBundle\Entity\Ern32\ICPNType $iCPN
     * @return self
     */
    public function setICPN(\DedexBundle\Entity\Ern32\ICPNType $iCPN)
    {
        $this->iCPN = $iCPN;
        return $this;
    }
