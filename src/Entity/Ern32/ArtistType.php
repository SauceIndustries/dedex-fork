...
class ArtistType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DedexBundle\Entity\Ern32\ArtistRoleType $artistRole)
    {
