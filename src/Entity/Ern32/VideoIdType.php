...
class VideoIdType
{
     ...
     *  Audiovisual Number as defined in ISO 15706) for the Video. An ISAN comprises four
     *  blocks of four hexadecimal charaters followed by a check character. DDEX will
     ...
     *  Video. A V-ISAN comprises four blocks of four hexadecimal charaters followed by a
     *  check character, followed by two further blocks of four hexadecimal characters,
     ...
     *  CatalogNumber of the Video.
     *
     * @var \DedexBundle\Entity\Ern32\CatalogNumberType $catalogNumber
     */
    private $catalogNumber = null;

    /**
     * A Composite containing details of a
     *  ProprietaryIdentifier of the Video (usually one per society involved in the
     *  messaging).
     *
     * @var \DedexBundle\Entity\Ern32\ProprietaryIdType[] $proprietaryId
     */
    ...
    /**
     * An Identifier of the Video assigned by the
     ...
     *  CatalogNumber of the Video.
     *
     * @return \DedexBundle\Entity\Ern32\CatalogNumberType
     */
     ...
     *  CatalogNumber of the Video.
     *
     * @param \DedexBundle\Entity\Ern32\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(\DedexBundle\Entity\Ern32\CatalogNumberType $catalogNumber)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DedexBundle\Entity\Ern32\ProprietaryIdType $proprietaryId)
    {
     ...
     *  messaging).
     *
     * @return \DedexBundle\Entity\Ern32\ProprietaryIdType[]
     */
