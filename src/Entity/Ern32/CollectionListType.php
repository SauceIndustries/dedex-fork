...
class CollectionListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\CollectionType $collection
     */
    public function addToCollection(\DedexBundle\Entity\Ern32\CollectionType $collection)
    {
     ...
     *  Collection contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern32\CollectionType[]
     */
