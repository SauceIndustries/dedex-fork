...
class PriceInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PriceTypeType $priceType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PriceRangeTypeType $priceRangeType
     */
     ...
     *  with PriceType.
     *
     * @var \DedexBundle\Entity\Ern32\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PriceType $suggestedRetailPrice
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @return \DedexBundle\Entity\Ern32\PriceTypeType
     */
     ...
     *  BulkOrderWholesalePricePerUnit.
     *
     * @param \DedexBundle\Entity\Ern32\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(\DedexBundle\Entity\Ern32\PriceTypeType $priceType)
    {
     ...
     *  on the Price to be used by the DSP.
     *
     * @return \DedexBundle\Entity\Ern32\PriceRangeTypeType
     */
     ...
     *  on the Price to be used by the DSP.
     *
     * @param \DedexBundle\Entity\Ern32\PriceRangeTypeType $priceRangeType
     * @return self
     */
    public function setPriceRangeType(\DedexBundle\Entity\Ern32\PriceRangeTypeType $priceRangeType)
    {
     ...
     *  with PriceType.
     *
     * @return \DedexBundle\Entity\Ern32\PriceType
     */
     ...
     *  with PriceType.
     *
     * @param \DedexBundle\Entity\Ern32\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(\DedexBundle\Entity\Ern32\PriceType $wholesalePricePerUnit)
    {
     ...
     *  not be combined with PriceType.
     *
     * @param \DedexBundle\Entity\Ern32\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(\DedexBundle\Entity\Ern32\PriceType $bulkOrderWholesalePricePerUnit)
    {
     ...
     *  suggested retail Price.
     *
     * @param \DedexBundle\Entity\Ern32\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(\DedexBundle\Entity\Ern32\PriceType $suggestedRetailPrice)
    {
