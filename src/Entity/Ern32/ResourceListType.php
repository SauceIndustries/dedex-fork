...
class ResourceListType
{
     ...
     *  SoundRecording.
     *
     * @var \DedexBundle\Entity\Ern32\SoundRecordingType[] $soundRecording
     */
     ...
     *  MIDI.
     *
     * @var \DedexBundle\Entity\Ern32\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *  Video.
     *
     * @var \DedexBundle\Entity\Ern32\VideoType[] $video
     */
    private $video = [
     ...
     *  Image.
     *
     * @var \DedexBundle\Entity\Ern32\ImageType[] $image
     */
    private $image = [
     ...
     *  Text.
     *
     * @var \DedexBundle\Entity\Ern32\TextType[] $text
     */
    private $text = [
     ...
     *  SheetMusic.
     *
     * @var \DedexBundle\Entity\Ern32\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *  of Software.
     *
     * @var \DedexBundle\Entity\Ern32\SoftwareType[] $software
     */
    private $software = [
     ...
     *  UserDefinedResource.
     *
     * @var \DedexBundle\Entity\Ern32\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern32\SoundRecordingType $soundRecording)
    {
     ...
     *  SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern32\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\MIDIType $mIDI
     */
    public function addToMIDI(\DedexBundle\Entity\Ern32\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     *  MIDI.
     *
     * @return \DedexBundle\Entity\Ern32\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\VideoType $video
     */
    public function addToVideo(\DedexBundle\Entity\Ern32\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     *  Video.
     *
     * @return \DedexBundle\Entity\Ern32\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ImageType $image
     */
    public function addToImage(\DedexBundle\Entity\Ern32\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     *  Image.
     *
     * @return \DedexBundle\Entity\Ern32\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\TextType $text
     */
    public function addToText(\DedexBundle\Entity\Ern32\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  Text.
     *
     * @return \DedexBundle\Entity\Ern32\TextType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern32\SheetMusicType $sheetMusic)
    {
     ...
     *  SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern32\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\SoftwareType $software
     */
    public function addToSoftware(\DedexBundle\Entity\Ern32\SoftwareType $software)
    {
     ...
     *  of Software.
     *
     * @return \DedexBundle\Entity\Ern32\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DedexBundle\Entity\Ern32\UserDefinedResourceType $userDefinedResource)
    {
     ...
     *  UserDefinedResource.
     *
     * @return \DedexBundle\Entity\Ern32\UserDefinedResourceType[]
     */
