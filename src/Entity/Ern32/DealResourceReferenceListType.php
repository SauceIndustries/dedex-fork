...
class DealResourceReferenceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PeriodType $period
     */
    private $period = null;
     ...
     *  Period of Time applicable to the Resources.
     *
     * @param \DedexBundle\Entity\Ern32\PeriodType $period
     * @return self
     */
    public function setPeriod(\DedexBundle\Entity\Ern32\PeriodType $period)
    {
        $this->period = $period;
        return $this;
    }
