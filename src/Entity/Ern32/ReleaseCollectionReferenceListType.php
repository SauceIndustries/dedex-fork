...
class ReleaseCollectionReferenceListType
{
     ...
     *  Episode.
     *
     * @var \DedexBundle\Entity\Ern32\ReleaseCollectionReferenceType[] $releaseCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReference(\DedexBundle\Entity\Ern32\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     *  Episode.
     *
     * @return \DedexBundle\Entity\Ern32\ReleaseCollectionReferenceType[]
     */
