...
class DealTermsType
{
     ...
     *  Service or Release.
     *
     * @var \DedexBundle\Entity\Ern32\CommercialModelTypeType[] $commercialModelType
     */
     ...
     *  applies.
     *
     * @var \DedexBundle\Entity\Ern32\UsageType[] $usage
     */
    private $usage = [
     ...
     *  DSP's website (=true) or not (=false). This element is deprecated. DDEX advises
     ...
     *  given.
     *
     * @var \DedexBundle\Entity\Ern32\DSPType[] $distributionChannel
     */
     ...
     *  herein.
     *
     * @var \DedexBundle\Entity\Ern32\DSPType[] $excludedDistributionChannel
     */
     ...
     *  Composite.
     *
     * @var \DedexBundle\Entity\Ern32\PriceInformationType[] $priceInformation
     */
     ...
     *  PromotionalCode.
     *
     * @var \DedexBundle\Entity\Ern32\PromotionalCodeType $promotionalCode
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PeriodType[] $validityPeriod
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ConsumerRentalPeriodType $consumerRentalPeriod
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $preOrderReleaseDate
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $preOrderPreviewDate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\DealResourceReferenceListType $preOrderIncentiveResourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\DealResourceReferenceListType $instantGratificationResourceList
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\RelatedReleaseOfferSetType[] $relatedReleaseOfferSet
     */
     ...
     *  returns.
     *
     * @var \DedexBundle\Entity\Ern32\PhysicalReturnsType $physicalReturns
     */
     ...
     *  claim policy.
     *
     * @var \DedexBundle\Entity\Ern32\RightsClaimPolicyType[] $rightsClaimPolicy
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\WebPolicyType[] $webPolicy
     */
    private $webPolicy = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\CommercialModelTypeType $commercialModelType
     */
    public function addToCommercialModelType(\DedexBundle\Entity\Ern32\CommercialModelTypeType $commercialModelType)
    {
     ...
     *  Service or Release.
     *
     * @return \DedexBundle\Entity\Ern32\CommercialModelTypeType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\UsageType $usage
     */
    public function addToUsage(\DedexBundle\Entity\Ern32\UsageType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     *  applies.
     *
     * @return \DedexBundle\Entity\Ern32\UsageType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\DSPType $distributionChannel
     */
    public function addToDistributionChannel(\DedexBundle\Entity\Ern32\DSPType $distributionChannel)
    {
     ...
     *  given.
     *
     * @return \DedexBundle\Entity\Ern32\DSPType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\DSPType $excludedDistributionChannel
     */
    public function addToExcludedDistributionChannel(\DedexBundle\Entity\Ern32\DSPType $excludedDistributionChannel)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\PriceInformationType $priceInformation
     */
    public function addToPriceInformation(\DedexBundle\Entity\Ern32\PriceInformationType $priceInformation)
    {
     ...
     *  Composite.
     *
     * @return \DedexBundle\Entity\Ern32\PriceInformationType[]
     */
     ...
     *  PromotionalCode.
     *
     * @return \DedexBundle\Entity\Ern32\PromotionalCodeType
     */
     ...
     *  PromotionalCode.
     *
     * @param \DedexBundle\Entity\Ern32\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(\DedexBundle\Entity\Ern32\PromotionalCodeType $promotionalCode)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\PeriodType $validityPeriod
     */
    public function addToValidityPeriod(\DedexBundle\Entity\Ern32\PeriodType $validityPeriod)
    {
     ...
     *  until further notice.
     *
     * @return \DedexBundle\Entity\Ern32\PeriodType[]
     */
     ...
     *  the DSP may rent something to a Customer.
     *
     * @return \DedexBundle\Entity\Ern32\ConsumerRentalPeriodType
     */
     ...
     *  the DSP may rent something to a Customer.
     *
     * @param \DedexBundle\Entity\Ern32\ConsumerRentalPeriodType $consumerRentalPeriod
     * @return self
     */
    public function setConsumerRentalPeriod(\DedexBundle\Entity\Ern32\ConsumerRentalPeriodType $consumerRentalPeriod)
    {
     ...
     *  with the syntax YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $preOrderReleaseDate
     * @return self
     */
    public function setPreOrderReleaseDate(\DedexBundle\Entity\Ern32\EventDateType $preOrderReleaseDate)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $preOrderPreviewDate
     * @return self
     */
    public function setPreOrderPreviewDate(\DedexBundle\Entity\Ern32\EventDateType $preOrderPreviewDate)
    {
     ...
     * @return self
     */
    public function setPreOrderPreviewDateTime(\DateTime $preOrderPreviewDateTime)
    {
     ...
     *  pre-order period (delivery is typically at ReleaseDate).
     *
     * @return \DedexBundle\Entity\Ern32\DealResourceReferenceListType
     */
     ...
     *  pre-order period (delivery is typically at ReleaseDate).
     *
     * @param \DedexBundle\Entity\Ern32\DealResourceReferenceListType $preOrderIncentiveResourceList
     * @return self
     */
    public function setPreOrderIncentiveResourceList(\DedexBundle\Entity\Ern32\DealResourceReferenceListType $preOrderIncentiveResourceList)
    {
     ...
     *  purchased (i.e. before the ReleaseDate).
     *
     * @param \DedexBundle\Entity\Ern32\DealResourceReferenceListType $instantGratificationResourceList
     * @return self
     */
    public function setInstantGratificationResourceList(\DedexBundle\Entity\Ern32\DealResourceReferenceListType $instantGratificationResourceList)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\RelatedReleaseOfferSetType $relatedReleaseOfferSet
     */
    public function addToRelatedReleaseOfferSet(\DedexBundle\Entity\Ern32\RelatedReleaseOfferSetType $relatedReleaseOfferSet)
    {
     ...
     *  more offers related to the Release.
     *
     * @return \DedexBundle\Entity\Ern32\RelatedReleaseOfferSetType[]
     */
     ...
     * @return self
     */
    public function setRelatedReleaseOfferSet(array $relatedReleaseOfferSet)
    {
        $this->relatedReleaseOfferSet = $relatedReleaseOfferSet;
        return $this;
    }
     ...
     *  returns.
     *
     * @return \DedexBundle\Entity\Ern32\PhysicalReturnsType
     */
     ...
     *  returns.
     *
     * @param \DedexBundle\Entity\Ern32\PhysicalReturnsType $physicalReturns
     * @return self
     */
    public function setPhysicalReturns(\DedexBundle\Entity\Ern32\PhysicalReturnsType $physicalReturns)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\RightsClaimPolicyType $rightsClaimPolicy
     */
    public function addToRightsClaimPolicy(\DedexBundle\Entity\Ern32\RightsClaimPolicyType $rightsClaimPolicy)
    {
     ...
     *  claim policy.
     *
     * @return \DedexBundle\Entity\Ern32\RightsClaimPolicyType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\WebPolicyType $webPolicy
     */
    public function addToWebPolicy(\DedexBundle\Entity\Ern32\WebPolicyType $webPolicy)
    {
     ...
     *  UserGeneratedContent permissions.
     *
     * @return \DedexBundle\Entity\Ern32\WebPolicyType[]
     */
     ...
     * @return self
     */
    public function setWebPolicy(array $webPolicy)
    {
        $this->webPolicy = $webPolicy;
        return $this;
    }
