...
class ReleaseListType
{
     ...
     *  Release.
     *
     * @var \DedexBundle\Entity\Ern32\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ReleaseType $release
     */
    public function addToRelease(\DedexBundle\Entity\Ern32\ReleaseType $release)
    {
     ...
     *  Release.
     *
     * @return \DedexBundle\Entity\Ern32\ReleaseType[]
     */
