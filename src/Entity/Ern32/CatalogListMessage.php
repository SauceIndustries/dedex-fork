 ...
 *  Suite Standard, containing a list of Releases that form part of a
 *  catalog.
 */
class CatalogListMessage
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DedexBundle\Entity\Ern32\CatalogItemType $catalogItem)
    {
     ...
     *  Release which is an item of the catalog.
     *
     * @return \DedexBundle\Entity\Ern32\CatalogItemType[]
     */
