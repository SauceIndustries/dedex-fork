...
class SoundRecordingCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern32\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DedexBundle\Entity\Ern32\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern32\SoundRecordingCollectionReferenceType[]
     */
