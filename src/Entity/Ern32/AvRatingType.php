...
class AvRatingType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\RatingAgencyType $ratingAgency
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\DescriptionType[] $ratingSchemeDescription
     */
     ...
     *  Organization that issues the AvRating.
     *
     * @return \DedexBundle\Entity\Ern32\RatingAgencyType
     */
     ...
     *  Organization that issues the AvRating.
     *
     * @param \DedexBundle\Entity\Ern32\RatingAgencyType $ratingAgency
     * @return self
     */
    public function setRatingAgency(\DedexBundle\Entity\Ern32\RatingAgencyType $ratingAgency)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\DescriptionType $ratingSchemeDescription
     */
    public function addToRatingSchemeDescription(\DedexBundle\Entity\Ern32\DescriptionType $ratingSchemeDescription)
    {
     ...
     * @return self
     */
    public function setRatingSchemeDescription(array $ratingSchemeDescription)
    {
        $this->ratingSchemeDescription = $ratingSchemeDescription;
        return $this;
    }
