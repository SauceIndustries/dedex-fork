...
class FileType
{
     ...
     *  the Resource. The FileName should conform to the relevant choreography
     *  standard (if one is used). It may not contain any path information and the
     ...
     *  generated.
     *
     * @var \DedexBundle\Entity\Ern32\HashSumType $hashSum
     */
     ...
     *  generated.
     *
     * @return \DedexBundle\Entity\Ern32\HashSumType
     */
     ...
     *  generated.
     *
     * @param \DedexBundle\Entity\Ern32\HashSumType $hashSum
     * @return self
     */
    public function setHashSum(\DedexBundle\Entity\Ern32\HashSumType $hashSum)
    {
