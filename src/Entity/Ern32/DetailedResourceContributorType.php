...
class DetailedResourceContributorType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *  the PartyName(s).
     *
     * @var \DedexBundle\Entity\Ern32\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ResourceContributorRoleType[] $resourceContributorRole
     */
     ...
     *  Artist.
     *
     * @var \DedexBundle\Entity\Ern32\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *  YYYY[-MM[-DD]].
     *
     * @var \DedexBundle\Entity\Ern32\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ArtistRoleType $primaryRole
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\PerformanceType[] $performance
     */
    private $performance = [
     ...
     *  SoundRecording.
     *
     * @var \DedexBundle\Entity\Ern32\GoverningAgreementTypeType $governingAgreementType
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ContactIdType $contactInformation
     */
     ...
     *  Artist.
     *
     * @var \DedexBundle\Entity\Ern32\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *  Artist has.
     *
     * @var \DedexBundle\Entity\Ern32\CurrentTerritoryCodeType $citizenship
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\ArtistRoleType[] $additionalRoles
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\MembershipType[] $membership
     */
    private $membership = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\PartyIdType $partyId
     */
    public function addToPartyId(\DedexBundle\Entity\Ern32\PartyIdType $partyId)
    {
     ...
     *  Artists, Producers or other Creators.
     *
     * @return \DedexBundle\Entity\Ern32\PartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\PartyNameType $partyName
     */
    public function addToPartyName(\DedexBundle\Entity\Ern32\PartyNameType $partyName)
    {
     ...
     *  the PartyName(s).
     *
     * @return \DedexBundle\Entity\Ern32\PartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ResourceContributorRoleType $resourceContributorRole
     */
    public function addToResourceContributorRole(\DedexBundle\Entity\Ern32\ResourceContributorRoleType $resourceContributorRole)
    {
     ...
     *  played by the Contributor.
     *
     * @return \DedexBundle\Entity\Ern32\ResourceContributorRoleType[]
     */
     ...
     *  Artist.
     *
     * @return \DedexBundle\Entity\Ern32\ArtistDelegatedUsageRightsType
     */
     ...
     *  Artist.
     *
     * @param \DedexBundle\Entity\Ern32\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     * @return self
     */
    public function setArtistDelegatedUsageRights(\DedexBundle\Entity\Ern32\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(\DedexBundle\Entity\Ern32\EventDateType $dateAndPlaceOfBirth)
    {
     ...
     *  YYYY[-MM[-DD]].
     *
     * @param \DedexBundle\Entity\Ern32\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(\DedexBundle\Entity\Ern32\EventDateType $dateAndPlaceOfDeath)
    {
     ...
     *  primary role played by the Artist in relation to other Artists.
     *
     * @return \DedexBundle\Entity\Ern32\ArtistRoleType
     */
     ...
     *  primary role played by the Artist in relation to other Artists.
     *
     * @param \DedexBundle\Entity\Ern32\ArtistRoleType $primaryRole
     * @return self
     */
    public function setPrimaryRole(\DedexBundle\Entity\Ern32\ArtistRoleType $primaryRole)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\PerformanceType $performance
     */
    public function addToPerformance(\DedexBundle\Entity\Ern32\PerformanceType $performance)
    {
     ...
     *  and Place of a Performance.
     *
     * @return \DedexBundle\Entity\Ern32\PerformanceType[]
     */
     ...
     *  SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern32\GoverningAgreementTypeType
     */
     ...
     *  SoundRecording.
     *
     * @param \DedexBundle\Entity\Ern32\GoverningAgreementTypeType $governingAgreementType
     * @return self
     */
    public function setGoverningAgreementType(\DedexBundle\Entity\Ern32\GoverningAgreementTypeType $governingAgreementType)
    {
     ...
     *  Identifiers of the Artist.
     *
     * @return \DedexBundle\Entity\Ern32\ContactIdType
     */
     ...
     *  Identifiers of the Artist.
     *
     * @param \DedexBundle\Entity\Ern32\ContactIdType $contactInformation
     * @return self
     */
    public function setContactInformation(\DedexBundle\Entity\Ern32\ContactIdType $contactInformation)
    {
     ...
     *  Artist.
     *
     * @param \DedexBundle\Entity\Ern32\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(\DedexBundle\Entity\Ern32\AllTerritoryCodeType $territoryOfResidency)
    {
     ...
     *  Artist has.
     *
     * @param \DedexBundle\Entity\Ern32\CurrentTerritoryCodeType $citizenship
     * @return self
     */
    public function setCitizenship(\DedexBundle\Entity\Ern32\CurrentTerritoryCodeType $citizenship)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\ArtistRoleType $additionalRoles
     */
    public function addToAdditionalRoles(\DedexBundle\Entity\Ern32\ArtistRoleType $additionalRoles)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\MembershipType $membership
     */
    public function addToMembership(\DedexBundle\Entity\Ern32\MembershipType $membership)
    {
     ...
     *  membership in a collective rights management organization.
     *
     * @return \DedexBundle\Entity\Ern32\MembershipType[]
     */
