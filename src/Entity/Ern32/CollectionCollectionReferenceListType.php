...
class CollectionCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DedexBundle\Entity\Ern32\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DedexBundle\Entity\Ern32\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DedexBundle\Entity\Ern32\CollectionCollectionReferenceType[]
     */
