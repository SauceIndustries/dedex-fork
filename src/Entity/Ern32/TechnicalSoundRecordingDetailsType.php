...
class TechnicalSoundRecordingDetailsType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\BitRateType $bitRate
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern32\SamplingRateType $samplingRate
     */
     ...
     *  audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DedexBundle\Entity\Ern32\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(\DedexBundle\Entity\Ern32\BitRateType $bitRate)
    {
     ...
     *  of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DedexBundle\Entity\Ern32\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(\DedexBundle\Entity\Ern32\SamplingRateType $samplingRate)
    {
