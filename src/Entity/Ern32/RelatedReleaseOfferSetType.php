...
class RelatedReleaseOfferSetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern32\DescriptionType $releaseDescription
     */
     ...
     *  Release.
     *
     * @var \DedexBundle\Entity\Ern32\DealType[] $deal
     */
    private $deal = [
     ...
     *  list individual Releases by xs:ID or Title.
     *
     * @param \DedexBundle\Entity\Ern32\DescriptionType $releaseDescription
     * @return self
     */
    public function setReleaseDescription(\DedexBundle\Entity\Ern32\DescriptionType $releaseDescription)
    {
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern32\DealType $deal
     */
    public function addToDeal(\DedexBundle\Entity\Ern32\DealType $deal)
    {
        $this->deal[] = $deal;
        return $this;
    }
     ...
     *  Release.
     *
     * @return \DedexBundle\Entity\Ern32\DealType[]
     */
